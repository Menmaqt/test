...
# domain random
CDN="https://raw.githubusercontent.com/Menmaqt/v4/main/ssh"
cd /root
...
echo -e "[ ${BGreen}INFO${NC} ] Alright good ... installation file is ready"
sleep 0.5
...
echo ""
wget -q https://raw.githubusercontent.com/Menmaqt/v4/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
    echo -e "$BBlue                     SETUP DOMAIN VPS     $NC"
    echo -e "$BYellow----------------------------------------------------------$NC"
    echo -e "$BGreen 1. Use Domain Random / Guna Domain Random $NC"
    echo -e "$BGreen 2. Use Your Own Domain / Guna Domain Sendiri $NC"
    echo -e "$BYellow----------------------------------------------------------$NC"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Menmaqt/v4/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/Menmaqt/v4/main/backup/set-br.sh &&  chmod +x set-br.sh && ./set-br.sh
clear
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Menmaqt/v4/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/Menmaqt/v4/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear

#Instal slowdns
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install SLDNS              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Menmaqt/v4/main/menu/versi  )
